<?php $__env->startSection('title', 'Password History'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        <?php if(auth()->guard()->check()): ?>
            <?php if($savedPasswords->isNotEmpty()): ?>
                <div class="mt-8">
                    ...
                    <div class="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        ...
                        <div class="flex items-center gap-4 w-full sm:w-auto">
                            <div class="text-sm text-gray-500 whitespace-nowrap">
                                <?php echo e($savedPasswords->total()); ?> saved passwords
                            </div>
                    ...
                    <div class="space-y-3" id="passwordHistory">
                        <?php $__currentLoopData = $savedPasswords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $password): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="password-item group flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200 border border-gray-200">
                            <div class="mb-3 sm:mb-0 sm:mr-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="font-mono text-gray-800 password-actual hidden"><?php echo e($password->password); ?></span>
                                    <button class="ml-2 text-gray-400 hover:text-gray-600" onclick="copyPasswordText(this)" data-password="<?php echo e($password->password); ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="text-xs text-gray-500 mt-2">
                                    <span>Created: <?php echo e($password->created_at->format('M d, Y H:i')); ?></span>
                                    <?php if($password->purpose): ?>
                                    <span class="ml-2">• Purpose: <span class="font-medium"><?php echo e($password->purpose); ?></span></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="w-16 bg-gray-200 rounded-full h-2 mr-2">
                                        <div class="h-2 rounded-full 
                                            <?php if($password->strength < 40): ?> bg-red-500
                                            <?php elseif($password->strength < 70): ?> bg-yellow-500
                                            <?php else: ?> bg-green-500 <?php endif; ?>" 
                                            style="width: <?php echo e($password->strength); ?>%">
                                        </div>
                                    </div>
                                    <span class="text-xs"><?php echo e($password->strength); ?>%</span>
                                </div>
                                <form method="POST" action="<?php echo e(route('password.delete', $password)); ?>" onsubmit="return confirm('Are you sure you want to delete this password?')">
                                    <?php echo csrf_field(); ?>
                    ...
                    <?php if($savedPasswords->hasPages()): ?>
                    <div class="mt-6">
                        <?php echo e($savedPasswords->onEachSide(1)->links()); ?>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('password.generator')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700">
                            Generate a Password
                        </a>
                    </div>
                </div>
...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="<?php echo e(route('passwords.add')); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\preci\Password-tool-complete\resources\views/password/history.blade.php ENDPATH**/ ?>