<?php $__env->startSection('title', 'Add New Password'); ?>
...
<div class="max-w-md mx-auto py-6">
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <form method="POST" action="<?php echo e(route('passwords.store')); ?>">
            <?php echo csrf_field(); ?>
    ...
    <div class="mt-4 text-center">
        <a href="<?php echo e(route('password.history')); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\preci\Password-tool-complete\resources\views/password/add.blade.php ENDPATH**/ ?>